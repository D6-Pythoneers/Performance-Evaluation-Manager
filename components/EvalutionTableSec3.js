        ...
        <div>
            ...
            <form className="w-full bg-white ">
                <thead className="  w-full bg-gray-500 text-white">
                    <tr>
                        <th className="border-b text-xs text-left border  w-1 text-center py-3 px-4  font-semibold text-sm">Number</th>
                        <th className="border-b text-xs text-left border  w-1 text-center py-3 px-4  font-semibold text-sm">Desigred Goal</th>
                        <th className="border-b text-xs text-left border  w-1 text-center py-3 px-4  font-semibold text-sm">Accopliched Goals</th>
                        <th className="border-b text-xs text-left border  w-1 text-center py-3 px-4  font-semibold text-sm">Maximum Mark</th>
                        <th className="border-b text-xs text-left border  w-1 text-center py-3 px-4  font-semibold text-sm">Minimum Mark</th>
                    </tr>
                </thead>
                <tbody className="m-8  gap-1 justify-evenly text-gray-700">
                <tr className=" border-b border border-black ">
                        <label className=" text-center py-3 px-4  font-semibold text-sm">3</label>
                        <td className="w-1/3 text-center py-3 px-4  ">
                            <textarea className="" type="text" placeholder='Typre here..' name="" />
                        </td>
                        <td className="w-1/3 text-center py-3 px-4 ">
                            <textarea className=" " type="text" placeholder='Typre here..' name="" />
                        </td>
